...
class DataLoader(data.Dataset):
    ...
    def get_all_samples(self):
        ...
        print("Found {} frames for training.".format(len(frames)))
        return frames               
    ...
    def __getitem__(self, index):
        ...
        start_index = self.videos[video_name]['frame'].index(frame_path)

        batch = []
        for i in range(self._time_step + self._num_pred):
            image_path = self.videos[video_name]['frame'][start_index + i]
